...
export class Game{
    constructor(width,height,imageRendering,keys=[],HTMLResponsive=false,HTMLId=null){
        ...
        this.autodraw=true;
        this.HTMLResponsive=HTMLResponsive;
    }
    async gameLoop(){
        if(this.HTMLResponsive){
            const HTMLcoords=this.HTMLCanvas.getBoundingClientRect();
            this.HTMLCanvas.width=HTMLcoords.width;
            this.HTMLCanvas.height=HTMLcoords.height;
        }
